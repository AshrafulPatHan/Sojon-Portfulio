            ...
            <div className='mt-4'>
                <footer className="footer bg-base-200 text-base-content p-10">
                    <nav>
                        ...
                        <a className="link link-hover">react Development</a>
                        <a className="link link-hover">node js Development</a>
                        <a className="link link-hover">express js Development</a>
                    </nav>
                    <nav>
                        <h6 className="footer-title">Mor Info</h6>
